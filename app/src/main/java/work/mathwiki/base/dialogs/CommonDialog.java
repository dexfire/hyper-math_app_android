package work.mathwiki.base.dialogs;
...
public class CommonDialog extends AppCompatDialog {
    ...
    protected DialogInterface.OnClickListener dismissClick = (dialog, which) -> dialog.dismiss();
    ...
    protected void init(final Context context) {
        ...
        headerVw = content.findViewById(R.id.dialog_header);
        container = content.findViewById(R.id.content_container);
        barDivider = content.findViewById(R.id.button_bar_divider);
        buttonDivider = content.findViewById(R.id.button_divder);
        positiveBt = content.findViewById(R.id.positive_bt);
        negativeBt = content.findViewById(R.id.negative_bt);
