package work.mathwiki.core.notice;
...
import work.mathwiki.AppApplication;
import work.mathwiki.MainActivity;
import work.mathwiki.R;
import work.mathwiki.core.api.remote.HyperApi;
import work.mathwiki.core.bean.base.ResultBean;
...
public class NoticeServer extends Service {
    ...
    // TODO mListenAccountChangeReceiver
    ...
    public void onCreate() {
        ...
        if (application instanceof AppApplication) {
            AppApplication.reInit();
        }

        mAlarmMgr = (AlarmManager) getSystemService(ALARM_SERVICE);
        // TODO ListenAccountChangeReceiver.start();
        //mListenAccountChangeReceiver = ListenAccountChangeReceiver.start(this);
    }

    @Override
    public void onDestroy() {
        // TODO ListenAccountChangeReceiver.destroy();
    ...
    private synchronized void refreshNoticeForNet() {
        ...
        mRunning = true;
        HyperApi.getNotice( new TextHttpResponseHandler() {
            @Override
    ...
    private synchronized void clearNoticeForNet(int flag) {
        ...
        if ((flag & NoticeManager.FLAG_CLEAR_MENTION) == NoticeManager.FLAG_CLEAR_MENTION
            ...
            mRunning = true;
            HyperApi.clearNotice(flag, new TextHttpResponseHandler() {
                @Override
                public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
