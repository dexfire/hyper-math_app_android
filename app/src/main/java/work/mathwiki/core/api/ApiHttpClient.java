...
import work.mathwiki.AppContext;
import work.mathwiki.core.account.AccountHelper;
import work.mathwiki.core.settings.Setting;
import work.mathwiki.core.api.git.API;
...
public class ApiHttpClient {
    ...
    public static void setHeaderNewsId() {
        ...
        CLIENT.addHeader("newsId", String.valueOf(AppSharedPreference.getInstance().getLastNewsId()));
    }
    ...
    public static void setHttpClient(AsyncHttpClient c) {
        ...
        if (TextUtils.isEmpty(sessionKey)) {
            sessionKey = MD5.get32MD5Str(AppSharedPreference.getInstance().getDeviceUUID() + System.currentTimeMillis());
        }
        c.addHeader("sessionKey", sessionKey);
        c.addHeader("uuid", AppSharedPreference.getInstance().getDeviceUUID());
